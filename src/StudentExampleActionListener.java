...
public class StudentExampleActionListener extends JApplet implements ActionListener {
	...
	public void graph(Graphics page) {
		...
		if (!inputLineNumber1.getText().equals("") && !inputLineNumber2.getText().equals("")) {
			...
			int result = 0;
			// *** method called here
			 result = drawLines(lineNumber1, lineNumber2, page);
			// *** method called here
			...
			page.setFont(regularFont);
			page.drawString("Number of lines:  " + result, 600, 570);
			page.drawString("Ackermann function is called:  " + counter, 600, 600);
			page.drawString("Ackermann value:  " + n, 600, 630);
			page.drawString("Enter line number 1: ", 40, 580);
			page.drawString("Enter line number 2: ", 40, 610);
		}
	}
	...
	private int drawLines(int lineNumber1, int lineNumber2, Graphics page) {
		...
		else if (lineNumber2 == 0)
			lineNumber2 = drawLines(lineNumber1 - 1, 1, page);
		else
			lineNumber2 = drawLines(lineNumber1 - 1, drawLines(lineNumber1, lineNumber2 - 1, page), page);
